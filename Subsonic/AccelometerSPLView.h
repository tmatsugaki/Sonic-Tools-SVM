 ...
 * FFT サンプリングレートなど
 */
#define ACCELO_SPL_SAMPLE_RATE      32     // 32
#define ACCELO_SPL_FRAME_SIZE       32     // 32
#define ACCELO_SPL_NUMCHANNELS      1       // 1
 ...
 * 描画用バッファ
 */
#define Accelo_SPL_BUFFER_SIZE      256       // 512

@protocol AccelometerSPLViewProtocol <NSObject>
- (void) singleTapped;
- (void) setFreezeMeasurement:(BOOL)yesNo;
@end

@interface AccelometerSPLView : UIView {
...
@property (assign, nonatomic) id <AccelometerSPLViewProtocol> delegate;
...
@property (assign, nonatomic) Float64 rawAccel;
@end
