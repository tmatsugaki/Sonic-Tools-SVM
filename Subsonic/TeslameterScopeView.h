 ...
 * FFT サンプリングレートなど
 */
#define TESLA_SCOPE_NUMCHANNELS        1   // 1
 ...
 * 描画用バッファ
 */
#define TESLA_SCOPE_BUFFER_SIZE        256     // 512

@protocol TeslameterScopeViewProtocol <NSObject>
- (void) singleTapped;
- (void) setFreezeMeasurement:(BOOL)yesNo;
@end

@interface TeslameterScopeView : UIView {
...
@property (assign, nonatomic) id <TeslameterScopeViewProtocol> delegate;
